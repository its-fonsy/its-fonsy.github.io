---
layout : post
title : Social Media (ITA)
---

Generalmente si pensa all'informatico come una persona chiusa in se stessa che
scrive codice per raggiungere un obiettivo che gli viene assegnato da qualcuno.
...
Diretto successore a Facebook è Instagram, in cui la componente testuale viene
ridotta all'osso e fa di video ed immagini il mezzo principale di
comunicazione. Questo ha portato l'utenza (molto giovane) ad adattarsi ai tipi
di contenuti da trasmettere.

Poche parole
------------

Instagram non è altro che una manifestazione di apparente perfezione, che
illude sia chi trasmette che chi guarda. Tra le migliaia di cause che questo
comporta (quali la generazione di insicurezze, il sentirsi fuori posto, ecc.)
quella che mi da più fastidio è l'illusione del fatto che basti **sembrare**
perfetti per esserlo.

La continua pubblicazione di storie in cui si condividono maggiormenti i
momenti belli farà credere a tutti (e a me) che io stia vivendo la vita
perfetta.
La ricerca spasmodica di attenzioni porta a fondare la propria persona sulle
opinioni degli altri. Oltretutto, visto che la comunicazione è fondata su
immagini e video l'unica cosa di cui ci si deve preoccupare è l'aspetto fisico.
...
ambire. Dopo ci sarà chi è più bello/a e dunque deciderà di dedicare poco più
tempo al suo corpo e ci sarà chi è più portato/a per la lettura e prediligierà 
leggere Dostojevski ad un'ora in palestra.
